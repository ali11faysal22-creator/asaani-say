...
// const geyserSubServices = [
//   {
//     id: 'Geyser Repair',
//     title: 'Geyser Repair',
//     subtitle: 'General Diagnosis & Quick Fix',
//     rating: '4.9',
//     price: 'Rs: 1800',
...
//     subtitle: 'Gas & Electric Geyser Setup',
//     rating: '4.9',
//     price: 'Rs: 3500',
//     image: '', // Add image path here
//   },
//   {
//     id: 'Geyser Maintenance',
//     title: 'Geyser Maintenance',
//     subtitle: 'Seasonal Checkup & Servicing',
//     rating: '4.8',
//     price: 'Rs: 2000',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Tank Descaling & Rust Removal',
//     rating: '4.8',
//     price: 'Rs: 1500',
//     image: '', // Add image path here
//   },
//   {
//     id: 'Geyser Replacement',
//     title: 'Geyser Replacement',
//     subtitle: 'Old Unit Removal & New Fitting',
//     rating: '4.9',
//     price: 'Rs: 4000',
//     image: '', // Add image path here
//   },
//   {
//     id: 'Gas Geyser Repair',
//     title: 'Gas Geyser Repair',
//     subtitle: 'Burner, Pilot & Valve Service',
//     rating: '4.8',
//     price: 'Rs: 2000',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Wiring, Coil & Power Fix',
//     rating: '4.8',
//     price: 'Rs: 2200',
//     image: '', // Add image path here
//   },
//   {
//     id: 'Geyser Leakage Repair',
//     title: 'Geyser Leakage Repair',
//     subtitle: 'Pipe, Valve & Tank Leakage Fix',
//     rating: '4.9',
//     price: 'Rs: 1800',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Temperature Control Replacement',
//     rating: '4.7',
//     price: 'Rs: 1500',
//     image: '', // Add image path here
//   },
//   {
//     id: 'Heating Element Replacement',
//     title: 'Heating Element Replacement',
//     subtitle: 'Heavy Duty Element Fitting',
//     rating: '4.9',
//     price: 'Rs: 2500',
//     image: '', // Add image path here
//   },
//   {
//     id: 'Gas Line Inspection',
//     title: 'Gas Line Inspection',
//     subtitle: 'Safety Leak Test & Connection Check',
//     rating: '4.8',
//     price: 'Rs: 1000',
//     image: '', // Add image path here
//   },
...
// export default function GeyserServicesPage() {
//   const [isModalOpen, setIsModalOpen] = useState(false)
//   const [selectedService, setSelectedService] = useState<typeof geyserSubServices[0] | null>(null)
//   const [quantity, setQuantity] = useState(1)

//   // UPDATED: Syncs item with localStorage and calculates dynamic quantities
//   const handleAddToCart = (service: typeof geyserSubServices[0]) => {
...
//         <Image
//           src="/geyser-banner.jpg"
//           alt="Geyser Services Banner"
//           fill
...
//           <h1 className="text-4xl sm:text-5xl font-black tracking-tight">Geyser Services</h1>
//           <p className="text-sm sm:text-base text-slate-100 font-medium">
//             Safe, Instant & Professional Water Heater Repair & Installation Solutions!
//           </p>
//         </div>
//       </section>
...
//             Choose From Our Wide Range Of Geyser Services
//           </h2>
//         </div>

//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
//           {geyserSubServices.map((item) => (
//             <div
//               key={item.id}
...
//             Best Geyser Repair & Installation Services In Pakistan – Asaani Say
//           </h2>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             From gas geyser burner tuning and electric element replacements to complete instant geyser installations and safety inspections, Asaani Say provides certified plumbing and heating technicians right at your home.
//           </p>
//         </div>

//         <div className="space-y-2 pt-2">
//           <h3 className="text-xl sm:text-2xl font-extrabold text-[#1E2342]">
//             Why Professional Geyser Servicing Is Crucial
//           </h3>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             Defective thermostats, gas line leaks, or clogged heating elements can raise electricity bills and create dangerous safety hazards. Our trained specialists use professional testing equipment to ensure safe and energy-efficient performance.
//           </p>
//         </div>
...
//               <span>Certified Gas & Electric Geyser Experts</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Comprehensive Gas Safety & Leak Check Included</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Quick Same-Day Response & Emergency Repairs</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Transparent Pricing & Genuine Replacement Parts</span>
//             </div>
//           </div>
//         </div>
//       </section>
...
export default function Page() {
  return <ServiceCategoryView slug="geyser" />
}
