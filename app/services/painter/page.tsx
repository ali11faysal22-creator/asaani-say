...
// const painterSubServices = [
//   {
//     id: 'Interior Painting',
//     title: 'Interior Painting',
//     subtitle: 'Full Indoor Wall & Ceiling Paint',
//     rating: '4.9',
//     price: 'Rs: 15000',
...
//     subtitle: 'Weatherproof Outer Wall Paint',
//     rating: '4.9',
//     price: 'Rs: 25000',
//     image: '', // Add image path here
//   },
...
//     id: 'Room Painting',
//     title: 'Room Painting',
//     subtitle: 'Single Room Standard Paint',
//     rating: '4.8',
//     price: 'Rs: 8000',
//     image: '', // Add image path here
//   },
...
//     id: 'Wall Painting',
//     title: 'Wall Painting',
//     subtitle: 'Per Single Feature Wall',
//     rating: '4.8',
//     price: 'Rs: 3500',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Smooth & Matte Ceiling Finish',
//     rating: '4.7',
//     price: 'Rs: 4000',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Enamel & Gloss Paint Coat',
//     rating: '4.8',
//     price: 'Rs: 2000',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Custom Modern Wall Textures',
//     rating: '4.9',
//     price: 'Rs: 6000',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Artistic & Accent Wall Designs',
//     rating: '4.9',
//     price: 'Rs: 7500',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Seepage & Dampness Shield Paint',
//     rating: '4.8',
//     price: 'Rs: 9000',
//     image: '', // Add image path here
//   },
...
//     id: 'Repainting',
//     title: 'Repainting',
//     subtitle: 'Touch-up & Refresh Paint Coat',
//     rating: '4.8',
//     price: 'Rs: 5000',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Smooth Finish for Metal & Wood',
//     rating: '4.7',
//     price: 'Rs: 4500',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Sanding, Priming & Putty Work',
//     rating: '4.8',
//     price: 'Rs: 2500',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Plaster Filling & Crack Sealing',
//     rating: '4.7',
//     price: 'Rs: 1500',
//     image: '', // Add image path here
//   },
...
// export default function PainterServicesPage() {
//   const [isModalOpen, setIsModalOpen] = useState(false)
//   const [selectedService, setSelectedService] = useState<typeof painterSubServices[0] | null>(null)
//   const [quantity, setQuantity] = useState(1)

//   // UPDATED: Syncs item with localStorage and calculates dynamic quantities
//   const handleAddToCart = (service: typeof painterSubServices[0]) => {
...
//         {/* Banner Image - Replace src path as needed */}
//         <Image
//           src="/pexels-anete-lusina-4792518.jpg"
//           alt="Painter Services Banner"
//           fill
...
//           <h1 className="text-4xl sm:text-5xl font-black tracking-tight">Painting Services</h1>
//           <p className="text-sm sm:text-base text-slate-100 font-medium">
//             Professional Interior, Exterior & Decorative Wall Painting Solutions!
//           </p>
//         </div>
//       </section>
...
//             Choose From Our Wide Range Of Painting Services
//           </h2>
//         </div>

//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
//           {painterSubServices.map((item) => (
//             <div
//               key={item.id}
...
//             Best House Painting Services In Pakistan – Asaani Say
//           </h2>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             From complete home interior repainting and exterior weather-proofing to texture designs, wall crack repairs, and spray painting, Asaani Say connects you with expert painters for flawless visual finishes.
//           </p>
//         </div>
...
//           </h3>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             Proper wall sanding, crack filling, and primer application are essential for long-lasting paint job quality. Our trained painters ensure smooth coverage, zero mess, and vibrant colors using premium brand paints.
//           </p>
//         </div>
...
//               <span>Skilled & Background-Checked Professional Painters</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Mess-Free & Clean Workmanship Guarantee</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Waterproofing & Crack Filling Expertise Included</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Transparent & Budget-Friendly Pricing</span>
//             </div>
//           </div>
//         </div>
//       </section>
...
export default function Page() {
  return <ServiceCategoryView slug="painter" />
}
