...
//     subtitle: 'Per Property / Full Audit',
//     rating: '4.5',
//     price: 'Rs: 15000',
//     image: '/pexels-pavel-danilyuk-7937325.jpg',
//   },
//   {
//     id: 'Pre-Sale Inspection',
//     title: 'Pre-Sale Inspection',
//     subtitle: 'Per Property / Full Audit',
//     rating: '4.5',
//     price: 'Rs: 12000',
//     image: '/pexels-mart-production-7414927.jpg',
//   },
//   {
//     id: 'Property Condition Inspection',
//     title: 'Property Condition Inspection',
//     subtitle: 'Structural Check',
//     rating: '4.5',
//     price: 'Rs: 10000',
//     image: '/pexels-rdne-8293642.jpg',
//   },
//   {
//     id: 'Structural Inspection',
//     title: 'Structural Inspection',
//     subtitle: 'Beams, Pillar & Foundation',
//     rating: '4.5',
//     price: 'Rs: 18000',
//     image: '/pexels-thirdman-8482646.jpg',
//   },
//   {
//     id: 'Electrical Inspection',
//     title: 'Electrical Inspection',
//     subtitle: 'Safety & Line Check',
//     rating: '4.5',
//     price: 'Rs: 5000',
//     image: '/pexels-vyvan-bui-vy-van-1139609066-39174644.jpg',
//   },
//   {
...
//     rating: '4.5',
//     price: 'Rs: 5000',
//     image: '/pexels-kathleen-austin-kuhn-2152973960-32497162.jpg',
//   },
// ]
...
//   // UPDATED: Syncs item with localStorage and calculates dynamic quantities
...
//         <Image
//           src="/pexels-pavel-danilyuk-7937754.jpg"
...
//           <h1 className="text-4xl sm:text-5xl font-black tracking-tight">Home Inspection</h1>
//           <p className="text-sm sm:text-base text-slate-100 font-medium">
//             We Inspect Every Detail – From Safety Checks To Complete Home Assessments!
//           </p>
//         </div>
//       </section>
...
//             Best Home Inspection Services In Pakistan – Asaani Say
//           </h2>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             Whether You’re Buying, Selling, Or Maintaining Your Property, A Professional Home Inspection Helps Identify Hidden Issues And Ensure Your Home Is Safe, Secure, And In Good Condition. Regular Inspections Can Help Prevent Costly Repairs And Give You Complete Peace Of Mind.
//           </p>
//         </div>
...
//           </h3>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             Before Buying, Selling, Or Moving Into A Property, A Professional Home Inspection Helps Ensure Everything Is In Good Condition. Neglecting A Proper Inspection Can Leave Hidden Structural, Electrical, Plumbing, Or Safety Issues Undetected, Leading To Unexpected Costs And Repairs.
//           </p>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             While Basic Home Checks Can Be Done By Homeowners, More Technical Issues Require Professional Inspection And Expertise. DIY Inspections Can Often Miss Hidden Problems Or Lead To Costly Repairs If Issues Are Not Identified Correctly.
//           </p>
//         </div>

//         <div className="space-y-2">
//           <h3 className="text-xl sm:text-2xl font-extrabold text-[#1E2342]">
//             Trusted Home Inspection Services By Asaani Say
//           </h3>
//           <div className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium space-y-2">
//             <p>
//               Finding Reliable Home Inspectors Can Be A Challenge – But That’s Where Asaani Say Comes In. We Provide Trusted Home Inspection Services Across Pakistan, Connecting You With Experienced Professionals For
//             </p>
//             <ul className="list-disc list-inside text-xs sm:text-sm text-slate-600 font-medium space-y-1 pl-2">
//               <li>Home Inspection & Property Assessment</li>
//               <li>Structural & Safety Inspection</li>
//               <li>Electrical & Plumbing Inspection</li>
//               <li>HVAC & Ventilation Inspection</li>
//               <li>Inspector On-Demand Services</li>
//             </ul>
//             <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium pt-1">
//               With Years Of Experience, Our Inspectors Are Skilled In Identifying Issues Across All Types Of Properties, Ensuring Thorough And Reliable Home Inspections.
//             </p>
//           </div>
//         </div>
...
//               <span>24/7 Home Inspection Services – No Extra Charges</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Trained & Verified Home Inspectors</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Fast, Reliable, And Transparent Inspections</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
...
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Comprehensive Home Inspection Services</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
...
//                 <span>🔧</span> Professional Home Inspector Services
//               </h3>
//               <p className="text-slate-500 font-medium leading-relaxed">
//                 Need The Best Home Inspector In Pakistan? We’ve Got You Covered For Property Inspections, Safety Checks, Structural Assessments, And Troubleshooting.
//               </p>
//             </div>

//             <div className="space-y-1">
//               <h3 className="font-bold text-[#1E2342] flex items-center gap-1.5">
//                 <span>🔧</span> Home Inspection Services
//               </h3>
//               <p className="text-slate-500 font-medium leading-relaxed">
//                 From Minor Concerns To Major Property Issues, We Handle All Types Of General Home Inspections And Assessments.
//               </p>
//             </div>

//             <div className="space-y-1">
//               <h3 className="font-bold text-[#1E2342] flex items-center gap-1.5">
//                 <span>🛠️</span> Home Inspection & Property Assessment Services
//               </h3>
//               <p className="text-slate-500 font-medium leading-relaxed">
...
//             <div className="space-y-1">
//               <h3 className="font-bold text-[#1E2342] flex items-center gap-1.5">
//                 <span>🔄</span> Home Maintenance Inspection Services
//               </h3>
//               <p className="text-slate-500 font-medium leading-relaxed">
//                 Keep Your Home In Top Condition With Routine Inspections And Detailed Assessments By Experienced Professionals.
//               </p>
//             </div>

//             <div className="space-y-1">
//               <h3 className="font-bold text-[#1E2342] flex items-center gap-1.5">
//                 <span>💨</span> Home Inspection & Safety Check Services
//               </h3>
//               <p className="text-slate-500 font-medium leading-relaxed">
//                 We Offer Thorough And Reliable Home Inspection Services To Identify Potential Issues And Ensure Your Property Remains Safe, Secure, And In Good Condition.
//               </p>
//             </div>
//           </div>
//         </div>
...
//             From <span className="font-extrabold text-[#1E2342]">Inspection To Assessment</span>, Property Checks To Expert Advice, We Do It All With Care, Professionalism, And Efficiency.
//           </p>
//         </div>
//       </section>
...
//                 Cart Subtotal ({quantity} {quantity > 1 ? 'Items' : 'Item'})
//               </span>
...
export default function Page() {
  return <ServiceCategoryView slug="home-inspection" />
}
