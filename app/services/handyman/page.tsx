...
// const handymanSubServices = [
//   {
//     id: 'Furniture Assembly',
//     title: 'Furniture Assembly',
//     subtitle: 'Table, Bed & Wardrobe Setup',
//     rating: '4.9',
//     price: 'Rs: 2500',
...
//     id: 'TV Mounting',
//     title: 'TV Mounting',
//     subtitle: 'All Screen Sizes & Brackets',
//     rating: '4.9',
//     price: 'Rs: 1500',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Per Window / Rod Fitting',
//     rating: '4.8',
//     price: 'Rs: 1000',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Wall Rack & Floating Shelves',
//     rating: '4.8',
//     price: 'Rs: 1200',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Frames, Mirror & Artwork',
//     rating: '4.7',
//     price: 'Rs: 800',
//     image: '', // Add image path here
//   },
...
//     id: 'Door Repair',
//     title: 'Door Repair',
//     subtitle: 'Hinge, Alignment & Handle Fix',
//     rating: '4.8',
//     price: 'Rs: 1800',
//     image: '', // Add image path here
//   },
...
//     id: 'Lock Repair',
//     title: 'Lock Repair',
//     subtitle: 'Lock & Latch Fitting / Fix',
//     rating: '4.9',
//     price: 'Rs: 1500',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Tap, Leakage & Sink Repair',
//     rating: '4.8',
//     price: 'Rs: 1200',
//     image: '', // Add image path here
//   },
//   {
//     id: 'Minor Electrical Work',
//     title: 'Minor Electrical Work',
//     subtitle: 'Switch, Plug & Bulb Fixing',
//     rating: '4.7',
//     price: 'Rs: 1000',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Miscellaneous Home Fixes',
//     rating: '4.9',
//     price: 'Rs: 2000',
//     image: '', // Add image path here
//   },
//   {
//     id: 'Drilling & Mounting',
//     title: 'Drilling & Mounting',
//     subtitle: 'Per Spot Wall Drilling',
//     rating: '4.8',
//     price: 'Rs: 800',
//     image: '', // Add image path here
//   },
...
//   const [selectedService, setSelectedService] = useState<typeof handymanSubServices[0] | null>(null)
//   const [quantity, setQuantity] = useState(1)

//   // UPDATED: Syncs item with localStorage and calculates dynamic quantities
//   const handleAddToCart = (service: typeof handymanSubServices[0]) => {
...
//         <Image
//           src="/pexels-ono-kosuki-5974235.jpg"
//           alt="Handyman Services Banner"
//           fill
...
//           <h1 className="text-4xl sm:text-5xl font-black tracking-tight">Handyman Services</h1>
//           <p className="text-sm sm:text-base text-slate-100 font-medium">
//             Reliable, Fast & Professional Home Repair & Maintenance Solutions!
//           </p>
//         </div>
//       </section>
...
//             Choose From Our Wide Range Of Handyman Services
//           </h2>
//         </div>

//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
//           {handymanSubServices.map((item) => (
//             <div
//               key={item.id}
...
//             Best Handyman Services In Pakistan – Asaani Say
//           </h2>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             From TV mounting and furniture assembly to minor plumbing and electrical fixes, Asaani Say provides trusted handyman professionals for all your everyday home maintenance and repair needs.
//           </p>
//         </div>
...
//           </h3>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             Small home repair jobs can quickly turn time-consuming and frustrating without the right tools. Our trained handymen bring professional equipment and expertise to execute quick, precise, and durable repairs.
//           </p>
//         </div>
...
//               <span>Fully Equipped & Background-Checked Technicians</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Same-Day & Flexible Booking Slots</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Affordable & Transparent Standard Rates</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
...
export default function Page() {
  return <ServiceCategoryView slug="handyman" />
}
