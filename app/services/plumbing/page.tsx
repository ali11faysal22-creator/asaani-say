...
//     id: 'Pipe Repair',
//     title: 'Pipe Repair',
//     subtitle: 'Pipe Leaks, Bursts & Joint Fitting Fixes',
//     rating: '4.9',
//     price: 'Rs: 2500',
//     image: '',
//   },
...
//     subtitle: 'Seepage Detection & Concealed Pipe Leakage',
//     rating: '4.8',
//     price: 'Rs: 3000',
//     image: '',
//   },
...
//     subtitle: 'Blocked Drain & Main Line Unclogging',
//     rating: '4.8',
//     price: 'Rs: 2000',
//     image: '',
//   },
...
//     subtitle: 'Mixer Tap, Spout & Leak Fixes',
//     rating: '4.7',
//     price: 'Rs: 1500',
//     image: '',
//   },
...
//     id: 'Sink Repair',
//     title: 'Sink Repair',
//     subtitle: 'Basin Waste Pipe & Sink Drainage Fix',
//     rating: '4.7',
//     price: 'Rs: 1800',
//     image: '',
//   },
...
//     id: 'Toilet Repair',
//     title: 'Toilet Repair',
//     subtitle: 'Flush Tank Mechanism & Commode Leakage',
//     rating: '4.8',
//     price: 'Rs: 2500',
//     image: '',
//   },
...
//     id: 'Shower Repair',
//     title: 'Shower Repair',
//     subtitle: 'Shower Panel, Mixer Valve & Head Replacement',
//     rating: '4.8',
//     price: 'Rs: 2000',
//     image: '',
//   },
...
//     subtitle: 'Overhead Tank Leakage & Valve Fixes',
//     rating: '4.9',
//     price: 'Rs: 5000',
//     image: '',
//   },
...
//     subtitle: 'Heavy Sewer Unclogging & Pipeline Fixes',
//     rating: '4.9',
//     price: 'Rs: 8000',
//     image: '',
//   },
...
//     subtitle: 'Complete Sanitary Fitting & Plumbing Layout',
//     rating: '4.9',
//     price: 'Rs: 6000',
//     image: '',
//   },
...
//     subtitle: 'Grease Trap, Sink & Line Connection',
//     rating: '4.8',
//     price: 'Rs: 4500',
//     image: '',
//   },
...
//     subtitle: 'New PPRC, PVC & GI Line Fittings',
//     rating: '4.8',
//     price: 'Rs: 5500',
//     image: '',
//   },
...
//   const [selectedService, setSelectedService] = useState<typeof plumbingSubServices[0] | null>(null)
//   const [quantity, setQuantity] = useState(1)

//   const handleAddToCart = (service: typeof plumbingSubServices[0]) => {
...
//         <Image
//           src="/pexels-janzakelj-9389356.jpg"
...
//           <h1 className="text-4xl sm:text-5xl font-black tracking-tight">Plumbing Services</h1>
//           <p className="text-sm sm:text-base text-slate-100 font-medium">
//             Fast, Reliable & Professional Plumbing Solutions for Your Home & Office!
//           </p>
//         </div>
//       </section>
...
//             Choose From Our Wide Range Of Plumbing Services
//           </h2>
//         </div>

//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
//           {plumbingSubServices.map((item) => (
//             <div
//               key={item.id}
...
//             Best Plumbing Services In Pakistan – Asaani Say
//           </h2>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             From pipe leak repair and drain unclogging to complete sanitary fittings and tank maintenance, Asaani Say connects you with verified plumbing specialists for quick and reliable fixes.
//           </p>
//         </div>

//         <div className="space-y-2 pt-2">
//           <h3 className="text-xl sm:text-2xl font-extrabold text-[#1E2342]">
//             Why Expert Plumbing Matters
//           </h3>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             Neglecting minor leaks or clogged drains can lead to severe structural wall dampness and costly repairs. Our certified plumbers use modern diagnostic tools to resolve issues without unnecessary damage to your walls or tiles.
//           </p>
//         </div>
...
//               <span>24/7 Emergency Leak Repair & Assistance</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
...
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Background-Checked & Experienced Plumbers</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Quality Material Guarantee & Neat Workmanship</span>
//             </div>
//           </div>
//         </div>
//       </section>
...
export default function Page() {
  return <ServiceCategoryView slug="plumbing" />
}
