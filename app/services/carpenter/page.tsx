...
// const carpenterSubServices = [
//   {
//     id: 'furniture-repair',
//     title: 'Furniture Repair',
//     subtitle: 'Sofa, Table & Chair Fix',
//     rating: '4.9',
//     price: 'Rs: 1500',
...
//     subtitle: 'Tailored Wooden Furniture',
//     rating: '4.9',
//     price: 'Rs: 10000',
//     image: '', // Add image path here
//   },
...
//     id: 'door-repair',
//     title: 'Door Repair',
//     subtitle: 'Hinge, Lock & Alignment Fix',
//     rating: '4.8',
//     price: 'Rs: 1200',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'New Wooden Door Fitting',
//     rating: '4.8',
//     price: 'Rs: 2500',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Wall & Storage Cabinet Setup',
//     rating: '4.8',
//     price: 'Rs: 3500',
//     image: '', // Add image path here
//   },
...
//     id: 'wardrobe-work',
//     title: 'Wardrobe Work',
//     subtitle: 'Sliding & Fixed Wardrobe Fix',
//     rating: '4.9',
//     price: 'Rs: 4000',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Custom Cabinet Making & Fix',
//     rating: '4.9',
//     price: 'Rs: 6000',
//     image: '', // Add image path here
//   },
...
//     id: 'shelving',
//     title: 'Shelving',
//     subtitle: 'Custom Wooden Wall Shelves',
//     rating: '4.8',
//     price: 'Rs: 1500',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Plank & Parquet Installation',
//     rating: '4.9',
//     price: 'Rs: 8000',
//     image: '', // Add image path here
//   },
...
//     subtitle: 'Polish, Staining & Refinishing',
//     rating: '4.8',
//     price: 'Rs: 3000',
//     image: '', // Add image path here
//   },
...
//     id: 'bed-repair',
//     title: 'Bed Repair',
//     subtitle: 'Bed Frame & Slate Adjustment',
//     rating: '4.8',
//     price: 'Rs: 2000',
//     image: '', // Add image path here
//   },
...
//     title: 'Table/Chair Repair',
//     subtitle: 'Leg, Surface & Joint Repair',
//     rating: '4.7',
//     price: 'Rs: 1000',
//     image: '', // Add image path here
//   },
...
// export default function CarpenterServicesPage() {
//   const [isModalOpen, setIsModalOpen] = useState(false)
//   const [selectedService, setSelectedService] = useState<typeof carpenterSubServices[0] | null>(null)
//   const [quantity, setQuantity] = useState(1)

//   // FIX: Updated handleAddToCart to persist data in LocalStorage
//   const handleAddToCart = (service: typeof carpenterSubServices[0]) => {
...
//         <Image
//           src="/pexels-hson-32357250.jpg"
//           alt="Carpenter Services Banner"
//           fill
...
//           <h1 className="text-4xl sm:text-5xl font-black tracking-tight">Carpenter Services</h1>
//           <p className="text-sm sm:text-base text-slate-100 font-medium">
//             Expert Woodwork, Custom Furniture & Reliable Home Repair Solutions!
//           </p>
//         </div>
//       </section>
...
//             Choose From Our Wide Range Of Carpenter Services
//           </h2>
//         </div>

//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
//           {carpenterSubServices.map((item) => (
//             <div
//               key={item.id}
...
//             Best Carpenter Services In Pakistan – Asaani Say
//           </h2>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             Whether you need custom kitchen cabinets, wardrobe repair, door installation, or premium wood polishing, Asaani Say brings skilled carpenters directly to your doorstep for seamless woodwork.
//           </p>
//         </div>
...
//           </h3>
//           <p className="text-xs sm:text-sm text-slate-500 leading-relaxed font-medium">
//             Quality woodwork requires precision, exact measurements, and professional tools. Our trained carpenters ensure accurate fittings, durable joint repairs, and long-lasting finishes for all your home and office furniture.
//           </p>
//         </div>
...
//               <span>Experienced & Background-Checked Craftsmen</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Custom Furniture & On-Demand Repair Solutions</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Upfront & Transparent Market Pricing</span>
//             </div>
//             <div className="flex items-center gap-2">
//               <span className="text-emerald-600 text-base">✅</span>
//               <span>Clean Workmanship & High-Quality Materials</span>
//             </div>
//           </div>
//         </div>
//       </section>
...
export default function Page() {
  return <ServiceCategoryView slug="carpenter" />
}
