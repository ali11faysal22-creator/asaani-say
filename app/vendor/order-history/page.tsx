...
export default function OrderHistoryPage() {
  ...
  const [filterDate, setFilterDate] = useState('2026-01-01')
  ...
  // Filter Orders based on Search Query and Status Tab
    ...
    <div className="min-h-screen w-full bg-white grid grid-cols-1 md:grid-cols-12 font-sans text-slate-800">
      ...
      <div className="md:col-span-8 lg:col-span-9 bg-[#F8FAFC] min-h-screen flex flex-col">
        <div className="flex-1">
          <div className="flex justify-end items-center gap-3 px-6 md:px-12 pt-6">
            <Link
              href="/cart"
              className="inline-flex items-center gap-2 bg-[#3A3E59] hover:bg-[#2C2F45] text-white px-4 py-3.5 rounded-lg text-xs font-semibold transition cursor-pointer"
            >
        ...
        <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-xs border border-slate-200/80 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 pb-5">
              ...
              {/* Total Spent & Total Orders Badges */}
