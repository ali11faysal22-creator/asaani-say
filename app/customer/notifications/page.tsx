...
import { ArrowLeft, Bell, CalendarDays, Check, Clock3, Trash2, X } from 'lucide-react'
import { deleteCustomerNotification, fetchCustomerBookings, fetchCustomerNotifications, formatSlotLabel, getCurrentUser, markAllCustomerNotificationsRead, markCustomerNotificationRead, type BookingResult, type CustomerNotification } from '../../lib/booking-api'
