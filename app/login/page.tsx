  ...
  return (
    <div className="min-h-screen w-full bg-[#171923] text-white flex flex-col justify-center items-center px-2 py-8 font-sans">
      ...
      <div className="max-w-4xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 my-8 px-2 sm:px-6 justify-items-center">
        ...
        <div className="bg-[#2D334A]/60 border-2 border-transparent hover:border-[#EE6C52] rounded-2xl p-4 flex flex-col justify-between transition-all hover:-translate-y-1 shadow-xl w-full max-w-107.5">
        ...
        <div className="bg-[#2D334A]/60 border-2 border-transparent hover:border-[#EE6C52] rounded-2xl p-4 flex flex-col justify-between transition-all hover:-translate-y-1 shadow-lg w-full max-w-107.5">
          <div className="space-y-3">
            <div className="relative w-full h-40 rounded-xl overflow-hidden bg-slate-800">
              <Image
                src="/customer2.jpg"
